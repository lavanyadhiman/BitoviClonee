...
function ContactForm() {
  ...
  return (
    <section className="relative overflow-hidden text-[#F9F9FD] bg-[#0B0D17]/[.95] w-[1440px] h-[530px] ml-[40px] flex justify-center items-center">
      <div className="relative z-10 flex flex-row justify-between p-8 h-full self-start lg:justify-self-end w-[min(100%,400px)] lg:w-auto lg:min-h-[400px]">
        ...
        <form onSubmit={handleSubmit} className="w-[392px] space-y-4">
